              ...
              <div className="mt-8 space-y-4 rounded-[24px] border border-dashed border-white/15 bg-white/3 p-8 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm leading-7 text-slate-300">
                    Fill out the form on the left and click "Generate test email" to create your 
                    AI-powered email draft. The generated content will appear here.
                  </p>
                </div>
                <div className="mx-auto max-w-md rounded-2xl border border-white/10 bg-slate-900/40 p-4 text-left text-xs leading-6 text-slate-400">
                  <p className="font-medium text-slate-300">💡 Troubleshooting Tips:</p>
                  <ul className="mt-2 space-y-1 pl-4">
                    <li>• <strong>401 Error:</strong> Invalid API key</li>
                    <li>• <strong>403 Error:</strong> Project ID or access policy issue</li>
                    <li>• <strong>Region Mismatch:</strong> Ensure region matches your project</li>
                  </ul>
                </div>
              </div>
            )}
